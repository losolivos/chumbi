...
class Player final : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void FitPlayerInTeam(bool action, Battleground* battleground = NULL);
    ...
    public:
        ...
        {
            m_taxi.InitTaxiNodesForLevel(getORace(), getClass(), oldLevel, newLevel);
        }
        ...
        void ResetCurrencyWeekCap(bool conquest = false);
        ...
        */
        ...
        void KilledMonsterCredit(uint32 entry, uint64 guid = 0, bool spell = false);
        ...
        void SendPersonalLoot(const LootTemplate* loot, Difficulty diff, uint16 lootmode);
        void SendItemToMailbox(uint32 item, uint32 count);
        ...
        void UnsummonBattlePetTemporary();
        ...
        uint32 GetCurrentPetSlot() const { return m_currentPetSlot; }
        void SetCurrentPetSlot(uint32 petSlot) { m_currentPetSlot = petSlot; }

        int8 GetSlotForNewPet() const;

        void SetPetSlotUsed(uint32 petId, uint8 slot) { m_petsBySlot.at(slot) = petId; }
        bool IsPetSlotUsed(uint8 slot)
        {
            if (m_petsBySlot.at(slot) != 0)
                return true;
    ...
    private:
        ...
        */
        ...
        void _SaveCurrency(SQLTransaction& trans, bool conquest = false);
