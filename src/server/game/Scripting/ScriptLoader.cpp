...
void AddSC_instance_cristmass_zulgurub();    // Zul`Gurub cristmass
...
void AddSC_boss_instructor_chillheart();            // Scholomance
...
void AddSC_timeless_isle();                        // Timeless Isle
...
void AddEasternKingdomsScripts()
{
    ...
    AddSC_instance_cristmass_zulgurub();    // Zul`Gurub cristmass
    AddSC_boss_doom_lord_cristmass();
...
void AddPandariaScripts()
{
    ...
    AddSC_boss_instructor_chillheart();            // Scholomance
    AddSC_boss_jandice_barov();
    AddSC_boss_rattlegore();
    AddSC_instance_schoolmance();
    ...
    AddSC_timeless_isle();                        // Timeless Isle
