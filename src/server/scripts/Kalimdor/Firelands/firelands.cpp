                        ...
                        for (Map::PlayerList::const_iterator itr = PlayerList.begin(); itr != PlayerList.end(); ++itr)
                        {
                            if (Player* pPlayer = itr->GetSource())
                            {
                                ...
                                if (!(pPlayer->getClass() == CLASS_MAGE ||
                                    ...
                                    (pPlayer->getClass() == CLASS_DRUID && (pPlayer->GetSpecializationId(pPlayer->GetActiveSpec()) == SPEC_DRUID_BALANCE || pPlayer->GetSpecializationId(pPlayer->GetActiveSpec()) == SPEC_DRUID_RESTORATION))))
                                    continue;
