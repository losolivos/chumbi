        ...
        struct boss_sha_of_prideAI : public BossAI
        {
            ...
            void CheckAndSetPrisonTiles()
            {
                ...
                if (canCheckNorth)
                {
                    ...
                    {
                        if (!GetPrisonTile(GO_NORTH_PRISON_A)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_NORTH_PRISON_A);
                    ...
                    {
                        if (!GetPrisonTile(GO_NORTH_PRISON_B)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_NORTH_PRISON_B);
                    ...
                    {
                        if (!GetPrisonTile(GO_NORTH_PRISON_C)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_NORTH_PRISON_C);
                ...
                if (canCheckSouth)
                {
                    ...
                    {
                        if (!GetPrisonTile(GO_SOUTH_PRISON_A)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_SOUTH_PRISON_A);
                    ...
                    {
                        if (!GetPrisonTile(GO_SOUTH_PRISON_B)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_SOUTH_PRISON_B);
                    ...
                    {
                        if (!GetPrisonTile(GO_SOUTH_PRISON_C)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_SOUTH_PRISON_C);
                ...
                if (canCheckWest)
                {
                    ...
                    {
                        if (!GetPrisonTile(GO_WEST_PRISON_A)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_WEST_PRISON_A);
                    ...
                    {
                        if (!GetPrisonTile(GO_WEST_PRISON_B)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_WEST_PRISON_B);
                    ...
                    {
                        if (!GetPrisonTile(GO_WEST_PRISON_C)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_WEST_PRISON_C);
                ...
                if (canCheckEast)
                {
                    ...
                    {
                        if (!GetPrisonTile(GO_EAST_PRISON_A)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_EAST_PRISON_A);
                    ...
                    {
                        if (!GetPrisonTile(GO_EAST_PRISON_B)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_EAST_PRISON_B);
                    ...
                    {
                        if (!GetPrisonTile(GO_EAST_PRISON_C)->FindNearestPlayer(1.0f))
                        {
                            ActivatePrisonTile(false, GO_EAST_PRISON_C);
