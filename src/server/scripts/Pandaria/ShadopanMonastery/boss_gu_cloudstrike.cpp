...
public:
    ...
    enum eSpells
    {
        ...
        SPELL_OVERCHARGED_SOUL_VISUAL = 110852
    };
    ...
    struct boss_gu_cloudstrikeAI : public BossAI
    {
        ...
        void DoAction(const int32 action) override
        {
            switch(action)
            {
                ...
                case ACTION_GU_P_3:
                    ...
                    me->RemoveAurasDueToSpell(SPELL_CHARGING_SOUL);
                    DoCast(me, SPELL_OVERCHARGED_SOUL_VISUAL, true);
                    break;
        ...
        void EnterCombat(Unit* who) override
        {
            if (!azurePhase)
            {
                ...
                events.ScheduleEvent(EVENT_TALK_CALLDRAGON, 3 * IN_MILLISECONDS);
            }
        }
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            if ((me->GetHealthPct()<=50) && !azurePhase)
            {
                azurePhase = true;
                events.Reset();
...
public:
    ...
    struct npc_azure_serpentAI : public ScriptedAI
    {
        ...
        void InitializeAI() override
        {
            ...
            events.ScheduleEvent(EVENT_STATIC_FIELD, 3* IN_MILLISECONDS);
        }
        ...
        void DoAction(const int32 action) override
        {
            if (action == ACTION_AZURE_SERPENT_P_2)
            {
                ...
                init.Launch(); 
                events.ScheduleEvent(EVENT_SWITCH_PHASE, 2* IN_MILLISECONDS);
            }
        }
        ...
        void UpdateAI(const uint32 diff) override
        {
            ...
            switch(events.ExecuteEvent())
            {
                ...
                case EVENT_MAGNETIC_SHROUD:
                    Talk(TALK_MAGNETIC);
                    DoCastAOE(SPELL_MAGNETIC_SHROUD);
                ...
                case EVENT_LIGHTNING_BREATH:
                    ...
                    DoCast(SelectTarget(SELECT_TARGET_RANDOM), SPELL_LIGHTNING_BREATH);
